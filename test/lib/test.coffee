...
describe 'test generator', ->
  ...
  describe 'month', ->
    ...
    it 'should have month 0 for january', ->
      ...
      day   = order.sunday()
      month = day.january()
      assert.equal month.ordinal, 1, 'ordinal should be 1'
      assert.equal month.day, 0, 'day should be 0'
      assert.equal month.month, 0, 'month should be 0'
    ...
    it 'should have month 1 for february', ->
      ...
      assert.equal month.day, 1, 'day should be 1'
      assert.equal month.month, 1, 'month should be 1'
    ...
    it 'should have month 2 for march', ->
      ...
      day   = order.tuesday()
      month = day.march()
      assert.equal month.ordinal, 3, 'ordinal should be 3'
      assert.equal month.day, 2, 'day should be 2'
      assert.equal month.month, 2, 'month should be 2'
    ...
    it 'should have month 3 for april', ->
      ...
      day   = order.wednesday()
      month = day.april()
      assert.equal month.ordinal, 4, 'ordinal should be 4'
      assert.equal month.day, 3, 'day should be 3'
      assert.equal month.month, 3, 'month should be 3'
    ...
    it 'should have month 4 for may', ->
      ...
      day   = order.thursday()
      month = day.may()
      assert.equal month.ordinal, 5, 'ordinal should be 5'
      assert.equal month.day, 4, 'day should be 4'
      assert.equal month.month, 4, 'month should be 4'
    ...
    it 'should have month 5 for june', ->
      ...
      month = day.june()
      assert.equal month.ordinal, 1, 'ordinal should be 1'
      assert.equal month.day, 5, 'day should be 5'
    ...
    it 'should have month 6 for july', ->
      ...
      month = day.july()
      assert.equal month.ordinal, 2, 'ordinal should be 2'
      assert.equal month.day, 6, 'day should be 6'
      assert.equal month.month, 6, 'month should be 6'
    ...
    it 'should have month 7 for august', ->
      ...
      assert.equal month.ordinal, 3, 'ordinal should be 3'
      assert.equal month.day, 0, 'day should be 0'
      assert.equal month.month, 7, 'month should be 7'
    ...
    it 'should have month 8 for september', ->
      ...
      assert.equal month.ordinal, 4, 'ordinal should be 4'
      assert.equal month.day, 1, 'day should be 1'
      assert.equal month.month, 8, 'month should be 8'
    ...
    it 'should have month 9 for october', ->
      ...
      assert.equal month.ordinal, 5, 'ordinal should be 5'
      assert.equal month.day, 2, 'day should be 2'
      assert.equal month.month, 9, 'month should be 9'
    ...
    it 'should have month 10 for november', ->
      ...
      assert.equal month.ordinal, 1, 'ordinal should be 1'
      assert.equal month.day, 3, 'day should be 3'
      assert.equal month.month, 10, 'month should be 10'
    ...
    it 'should have month 11 for december', ->
      ...
      assert.equal month.ordinal, 2, 'ordinal should be 2'
      assert.equal month.day, 4, 'day should be 4'
      assert.equal month.month, 11, 'month should be 11'
